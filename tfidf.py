...
# J'obtiens une amélioration très nette de la performance de mon modèle en utilisant TF-IDF lors
# de la construction des vecteurs de mot (build_word_vector()).
